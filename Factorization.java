...
public class Factorization {
	...
	public Factorization(int MAX_PRIME) {
...
//					fo.write("\n");
	...
	public void solve(BigInteger N) {
		init(N);
		Gauss();
	}
...
//		System.out.println(P + " " + Q + " " + N); 
		BigInteger N = new BigInteger("662875573009490731045345994740327457245824480677");
